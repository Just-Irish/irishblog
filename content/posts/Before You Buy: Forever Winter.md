...
* The game's optimization is pretty bad, but that can be expected from an Early Access title made from a team of twenty people (thirty, according to the current website) with such a grand vision.

* The controls can feel sluggish due to how your character responds to mouse and key inputs. It is *not* due to frame generation, it is simply the gameplay.

* The third-person camera requires work as it can cause your character to block your view when situational awareness is a direct influence to your survival.

* The game is difficult. You might as well be nothing more than dirt when compared to the warring factions.

* The AI is a bit *wonky* with an added dash of **infuriating**. Their pathfinding reminds me of ArmA 3's waypoints system assisted by a bad Zeus spawning a squad right on top of you.

* The atmosphere, art style, and soundtrack are unrivaled.

## Critiques and What to Expect

### Optimization

It needs a lot fo work. The developers are fully aware of the poor performance and are priioritizing getting it fixed and playable for those with rigs that are not up to date with the latest, greatest, and most embarrassing modern hardware. Currently, I have all my settings set to "Low" and I *still* get between forty-fice and sixty FPS; and that's with a top-of-the-line computer.

### Movement

You wouldn't think anyone would need to say anything about this, but I think it is important to know before getting into the game. Everything feels sluggish; and that's due to the nature of the game. It is meant to be a slow process because if you do not take care you will not survive.

But there are other factors contributing to this. For instance, you can only sprint forwards, not diagonally. This can lead to accidentally getting stuck on the corner of buildings and objects until you stop sprinting, which, in turn, can get you klled if you happened to be fleeing something. If you go into this game thinking the controls will handle like other third-person games like Assassin's Creed or Tom Clancy's Wildlands, you will be disappointed.
...
It. Is. Rough. It is not easy. One small mistake will get you killed if you are unprepared. For instance: a soldier blocks your path, so you decide to kill him; unbeknownst to you there were more just around the corner and now they are running full tilt in your direction; you turn to run but they get line-of-dight and promptly bathe you in a stream of hot leat.

You are nothing more than a fart in the wind that is quite literally an inconvienence to a squad of bio-engineered soldiers on their way to die themselves.

You are also a beacon for the enemy to spawn on top of. It is not intentional; you just happen to be standing on or right next to the plethora of spawn points on the map and the game doesn't care if you are in the vicinity. I don't know if this is something the developers are going to address, but I can see why they wouldn't even though it is extremely infuriating if it gets you killed: if they change the spawns to deactivate when you are near then there is not need to be afraid and constantly on the move. But I'm sure something can be done to still keep on the pressue without having the game cheat you.
...
The standard weapon in the game will be Rifles, like you AKs and M4s. These will be your bread and butter as they are the easiest to use and the default character specializes in them.

In my experience so far, shotguns have been utter dogshit except when you have a couple Cyborgs rushing you as it then becomes trivial to headshot them. Otherwise? Don't use them for anything unless you want to die. I haven't used any of the automatic shotguns like the AA-12 yet, so maybe they are vastly superior to their pump-action counterparts.

Pistols are another option. I generally prefer taking a pistol over a shotgun due to everything weighing less and allowing me to carry more crap around with me. I've also had better luck with pistols saving my ass compared to a shotgun, surprisingly.

Haven't used SMGs a whole lot, but they're similar to Rifles, just less damage.

There are also LMGs, Grenade Launchers, and specialty weapons that can only be found in raid. I ahven't used any of them, but I'm hoping they're good and relevant.
...
Also know as *The Innards*, is your little home where you can choose to either run around to each station and vendor to do your business or you can just use the escape menu to do everything. As you progress you unock new vendors and can also purchase upgrades for you home. These upgrades are currently pretty minor as there are two legitimate upgrades available for purchase and then some cosmetic upgrades.

Every now and then your home will be raided by water bandits, so be prepared for that shock or you'll lose all your water. They're pretty easy to deal with if you know about it, but I did not...

## Conclusion

There's a lot of problems, and most really just come down to the game needing optimization, the AI needing some TLC, and an established endgame to work towards. There's a lot of potential for the game as long as the developers continue to be pro-consumer and continue to listen to the community like they are. In one of their Q&A's people have given suggestions and their responses have been, "I like that, that's fucking awesome."
